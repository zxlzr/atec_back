...
tf.flags.DEFINE_integer("random_seed", 33, "Random seed to split train and test. (default: None)")
...
# Training parameters
tf.flags.DEFINE_string("model_dir", "../model/rcnn_10_new5", "Model directory (default: ./model)")
    ...
    if FLAGS.Submit is False:
        ...
        for train_index, test_index in kf.split(data):
            ...
            with tf.Graph().as_default():
                ...
                print("Saved model with F1={} checkpoint to {}\n".format(F1_best, path))
                f1_total+=F1_best
        print("total f1:  "+(str)(f1_total/20))	
