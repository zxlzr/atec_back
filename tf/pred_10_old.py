...
if __name__ == '__main__':
    ...
    out1 = main(data, '1.txt','checkpoints/model1-11000.meta')
    x1 = np.asarray(out1)
    out2 = main(data, '2.txt','checkpoints/model2-11500.meta')
    x2 = np.asarray(out2)   
    out3 = main(data, '3.txt','checkpoints/model3-4800.meta')
    x3 = np.asarray(out3)
    out4 = main(data, '4.txt','checkpoints/model4-11400.meta')
    x4 = np.asarray(out4)
    #out5 = main(sys.argv[1], '5.txt','checkpoints/model1-11000.meta')
    #x5 = np.asarray(out5)
    #out6 = main(sys.argv[1], '6.txt','checkpoints/model1-11000.meta')
    #x6 = np.asarray(out6)
    #out7 = main(sys.argv[1], '7.txt','checkpoints/model1-11000.meta')
    #x7 = np.asarray(out7)
    out8 = main(data, '8.txt','checkpoints/model8-10700.meta')
    x8 = np.asarray(out8)
    #out9 = main(sys.argv[1], '9.txt','checkpoints/model1-11000.meta')
    #x9 = np.asarray(out9) 
    #out10 = main(sys.argv[1], '10.txt','checkpoints/model1-11000.meta')
