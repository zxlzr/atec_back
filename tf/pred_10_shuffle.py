...
import numpy as np
FLAGS.model_dir = '../model/rcnn_10_shuffle/'
...
if __name__ == '__main__':
    ...
    out1 = main(data, '1.txt','checkpoints/model1-15201.meta')
    x1 = np.asarray(out1)
    out2 = main(data, '2.txt','checkpoints/model2-22001.meta')
    x2 = np.asarray(out2)   
    out3 = main(data, '3.txt','checkpoints/model3-21001.meta')
    x3 = np.asarray(out3)
    out4 = main(data, '4.txt','checkpoints/model4-19901.meta')
    x4 = np.asarray(out4)
    out5 = main(data, '5.txt','checkpoints/model5-23101.meta')
    x5 = np.asarray(out5)
    out6 = main(data, '6.txt','checkpoints/model6-18801.meta')
    x6 = np.asarray(out6)
    out7 = main(data, '7.txt','checkpoints/model7-17701.meta')
    x7 = np.asarray(out7)
    out8 = main(data, '8.txt','checkpoints/model8-20701.meta')
    x8 = np.asarray(out8)
    out9 = main(data, '9.txt','checkpoints/model9-14101.meta')
    x9 = np.asarray(out9) 
    out10 = main(data, '10.txt','checkpoints/model10-18201.meta')
