...
def main(input_file, output_file):
    ...
    with graph.as_default():  # with tf.Graph().as_default() as g:
        ...
        with sess.as_default():
            ...
            meta_file = os.path.abspath(os.path.join(FLAGS.model_dir, 'checkpoints/model-23490.meta'))
            ...
            with open(output_file, 'w') as fo:
                ...
                for batch in batches:
                    ...
                    e = sess.run([e], {input_x1: x1_batch, input_x2: x2_batch, dropout_keep_prob: 1.0})
