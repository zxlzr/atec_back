...
tf.flags.DEFINE_integer("random_seed", 37, "Random seed to split train and test. (default: None)")
...
tf.flags.DEFINE_float("pred_threshold", 0.45, "Threshold for classify.(default: 0.5)")
...
# Training parameters
tf.flags.DEFINE_string("model_dir", "../model/test6", "Model directory (default: ./model)")
tf.flags.DEFINE_integer("batch_size", 128, "Batch Size (default: 64)")
tf.flags.DEFINE_float("lr", 1e-3, "Initial learning rate (default: 1e-3)")
tf.flags.DEFINE_float("weight_decay_rate", 1.0, "Exponential weight decay rate (default: 0.9) ") #重要参数
