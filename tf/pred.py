...
def main(input_file, output_file):
    ...
    with graph.as_default():  # with tf.Graph().as_default() as g:
        ...
        with sess.as_default():
            ...
            meta_file = os.path.abspath(os.path.join(FLAGS.model_dir, 'checkpoints/model-5481.meta'))
            ...
            with open(output_file, 'w') as fo:
                ...
                for batch in batches:
                    ...
                    dpool = dynamic_pooling_index(seqlen1, seqlen2, 34, 34)
                    y_pred_ = sess.run([y_pred], {dpool_index: dpool,input_x1: x1_batch, input_x2: x2_batch, dropout_keep_prob: 1.0,x_scene_len: seqlen1,x_title_len: seqlen2,})
